    ...
    final result = <Object>[
      ...
      serializers.serialize(object.paths,
          specifiedType:
              const FullType(BuiltList, const [const FullType(String)])),
      'localPaths',
      serializers.serialize(object.localPaths,
          specifiedType:
              const FullType(BuiltList, const [const FullType(String)])),
      'tags',
      serializers.serialize(object.tags,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'paths':
          ...
          break;
        case 'localPaths':
          result.localPaths.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(BuiltList, const [const FullType(String)]))
              as BuiltList<Object>);
          break;
...
class _$PostsState extends PostsState {
  ...
  _$PostsState._({this.posts, this.info}) : super._() {
    if (posts == null) {
...
class _$PostInfo extends PostInfo {
  ...
  @override
  final BuiltList<String> localPaths;
  @override
  final BuiltList<String> tags;
  @override
  final String description;
  ...
  _$PostInfo._(
    ...
    if (localPaths == null) {
      throw new BuiltValueNullFieldError('PostInfo', 'localPaths');
    }
    if (tags == null) {
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc(
                $jc(
                    $jc($jc($jc(0, paths.hashCode), localPaths.hashCode),
                        tags.hashCode),
                    description.hashCode),
                users.hashCode),
            lng.hashCode),
...
class PostInfoBuilder implements Builder<PostInfo, PostInfoBuilder> {
  ...
  ListBuilder<String> _localPaths;
  ListBuilder<String> get localPaths =>
      _$this._localPaths ??= new ListBuilder<String>();
  set localPaths(ListBuilder<String> localPaths) =>
      _$this._localPaths = localPaths;
  ...
  PostInfoBuilder get _$this {
    if (_$v != null) {
      ...
      _localPaths = _$v.localPaths?.toBuilder();
      _tags = _$v.tags?.toBuilder();
      _description = _$v.description;
      _users = _$v.users?.toBuilder();
      _lng = _$v.lng;
